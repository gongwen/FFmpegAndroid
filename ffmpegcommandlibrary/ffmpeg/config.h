...
#define FFMPEG_CONFIGURATION "--prefix=../android_lib/armv7-a --target-os=android --arch=arm --cpu=armv7-a --sysroot=/Users/gongwen/FFmpeg/android-ndk-r14b/platforms/android-21/arch-arm --cross-prefix=/Users/gongwen/FFmpeg/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --extra-cflags='-march=armv7-a -mfpu=neon -mfloat-abi=softfp -mvectorize-with-neon-quad' --extra-ldflags='-Wl,--fix-cortex-a8' --extra-ldexeflags=-pie --enable-cross-compile --enable-gpl --enable-nonfree --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-network --disable-symver --disable-asm --disable-programs --disable-static --enable-shared --enable-small --disable-protocols --disable-avdevice --enable-encoders --enable-decoders --enable-avfilter"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "../android_lib/armv7-a/share/ffmpeg"
#define AVCONV_DATADIR "../android_lib/armv7-a/share/ffmpeg"
